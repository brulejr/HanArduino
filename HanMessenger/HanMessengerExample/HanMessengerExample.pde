// This example demonstrates HanMessenger's callback  & attach methods
// For Arduino Uno and Arduino Duemilanove board (may work with other)

// Download these into your Sketches/libraries/ folder...

// HanMessenger library available from https://github.com/dreamcat4/cmdmessenger
...
// Attach a new HanMessenger object to the default Serial port
HanMessenger cmdMessenger = HanMessenger(Serial, field_separator, command_separator);
...
// If you run out of message slots, then just increase the value of MAXCALLBACKS in HanMessenger.h
